...
class ProductCategory(models.Model):
	...
	product_type_filter = fields.Selection([('all', 'All Products'), ('service', 'Services Only'), ('product', 'Products Only')], string='Category Product Type Filter',
										   required=True, default='all', help="Filter the products shown by default when viewing this category's products.\n"
